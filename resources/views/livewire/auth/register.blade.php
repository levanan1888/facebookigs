                ...
                <div class="bg-white rounded-lg shadow-lg p-8 border border-gray-200">
                    ...
                    <form method="POST" wire:submit="register" class="space-y-4">
                        ...
                        <div>
                            <button
                                type="submit"
                                class="w-full bg-green-500 hover:bg-green-600 text-white font-bold text-base py-3 px-4 rounded-lg transition-colors duration-200"
                            >
                                Đăng ký
                            </button>
                        </div>
                    ...
                    <div class="mt-6 text-center">
                        <a href="{{ route('login') }}" 
                           class="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold text-base py-3 px-4 rounded-lg transition-colors duration-200 inline-block text-center">
                            Đăng nhập
                        </a>
                    </div>
                </div>
