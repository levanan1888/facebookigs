        ...
        <div class="p-6">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-lg rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700">
                <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Chi tiết hoạt động đăng nhập</h3>
                </div>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- User Information -->
                        <div class="space-y-4">
                            <h4 class="text-lg font-medium text-gray-900 dark:text-white">Thông tin người dùng</h4>
                            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 space-y-3">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="text-sm font-semibold text-gray-900 dark:text-white">{{ $loginActivity->user->name }}</div>
                                        <div class="text-sm text-gray-500 dark:text-gray-400">{{ $loginActivity->user->email }}</div>
                                    </div>
                                </div>
                        ...
                        <div class="space-y-4">
                            <h4 class="text-lg font-medium text-gray-900 dark:text-white">Thông tin hoạt động</h4>
                            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 space-y-3">
                                <div class="flex items-center justify-between">
                                    <span class="text-sm font-medium text-gray-600 dark:text-gray-400">Hành động:</span>
                        ...
                        <div class="space-y-4">
                            <h4 class="text-lg font-medium text-gray-900 dark:text-white">Thông tin kỹ thuật</h4>
                            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 space-y-3">
                        ...
                        <!-- Timestamps -->
                        <div class="space-y-4">
                            <h4 class="text-lg font-medium text-gray-900 dark:text-white">Timestamps</h4>
                            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 space-y-3">
