    ...
    <flux:main>
        <div class="p-6">
            ...
            <div class="flex flex-wrap gap-4 mb-8">
                <div class="w-full sm:w-1/2 lg:w-1/6 bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 p-6 hover:shadow-lg transition-shadow duration-200">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <p class="text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Tổng đăng nhập</p>
                ...
                <div class="w-full sm:w-1/2 lg:w-1/6 bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 p-6 hover:shadow-lg transition-shadow duration-200">
                    <div class="flex flex-col items-center text-center">
                        <div class="p-3 bg-red-100 dark:bg-red-900 rounded-xl mb-3">
                            <svg class="w-8 h-8 text-red-600 dark:text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.34 16.5c-.77.833.192 2.5 1.732 2.5z"></path>
                            </svg>
                        </div>
                        <p class="text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Đăng nhập thất bại</p>
                ...
                <div class="w-full sm:w-1/2 lg:w-1/6 bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 p-6 hover:shadow-lg transition-shadow duration-200">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <p class="text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Hôm nay</p>
                        <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $stats['today_logins'] }}</p>
                    </div>
                </div>
                ...
                <div class="w-full sm:w-1/2 lg:w-1/6 bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 p-6 hover:shadow-lg transition-shadow duration-200">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <p class="text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Users hôm nay</p>
                        <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $stats['unique_users_today'] }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 shadow-lg rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700">
                <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700">
                    <div class="flex items-center justify-between">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Hoạt động đăng nhập</h3>
                        <div class="flex items-center space-x-2">
                            <span class="text-sm text-gray-500 dark:text-gray-400">Hiển thị {{ $loginActivities->count() }} / {{ $loginActivities->total() }}</span>
                        </div>
                    </div>
                </div>
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-150">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            <div class="text-sm font-semibold text-gray-900 dark:text-white">{{ $activity->user->name }}</div>
